...
ZONAS_AUTO = ['MARIA GRANDE', 'EL PINGO', 'HASENKAMP', 'CERRITO', 'ARROYO BURGOS', 'LAS GARZAS', 'EL PALENQUE', 'ALDEA SANTA MARIA', 'ESTACION SOSA', 'ALCARAZ', 'VILLA URQUIZA', 'HERNANDARIAS', 'PIEDRAS BLANCAS', 'PUEBLO BRUGO']
